...
top_frame = Frame(root, bg='cyan', width=200, height=50, pady=0)
...
circle_img_label = Label(top_frame, image=circle, bg="white")
...
circle_img_label.grid(row=0, column=0, sticky=N)

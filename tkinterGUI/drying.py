...
drying_img = (Image.open("images/dry.png"))
resized_img = drying_img.resize((280, 280), Image.ANTIALIAS)
drying = ImageTk.PhotoImage(resized_img)
drying_img_label = Label(image=drying, bg="white")

# "Drying NGT" label widget
dryingNGT_label = Label(root, text="Drying NGT", bg="white", font=("Arial bold", 24))
...
drying_img_label.grid(row=0, column=0, sticky=NS)
dht_label.grid(row=0, column=0, sticky=NE)

# Inflating the widgets in the bottom frame
dryingNGT_label.grid(row=1, column=0, sticky=N)
